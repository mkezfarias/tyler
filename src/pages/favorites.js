    ...
    items: [
      {
        ...
        subText: "A book about life itself. Beautiful and tragic it lays bare the ideas and decisions we each wrestle with about who we will be, what we’ll believe, and who we will love.",
      },
      {
        link: "https://bookshop.org/books/fathers-and-sons-9781627651486/9780199536047",
      ...
      {
        link: "https://www.amazon.com/Whats-Best-Next-Gospel-Transforms/dp/0310533988",
        subTitle: "What’s Best Next",
        subText: "A productivity book that is half theology and half tactics. If nothing else, it has helped me ask the most important question during my day, “What is best next?” ",
      },
      {
        link: "https://bookshop.org/books/the-wind-up-bird-chronicle/9780679775430",
        subTitle: "The Wind Up Bird Chronicle",
        subText: "Murakami is one of my favorite authors because his writing dives deep into the characters and how they think. Despite a wandering storyline, Chronicle (which is really 3 books in 1)  mirrors real life. Like many Murakami books, it doesn't all make sense (which seems like life to me).",
      },
      {
        link: "https://bookshop.org/books/the-way-of-the-superior-man-a-spiritual-guide-to-mastering-the-challenges-of-women-work-and-sexual-desire-20th-anniversary-edition-9781622038329/9781622038329",
        subTitle: "Way of the Superior Man",
        subText: "I agree 100% with 20% of this book. The early chapters about life, finding your edge, dealing with fear, and living from your source are some of the most inspiring pages I’ve read. Highly recommend Part 1 but skip Part 2 and Part 3.",
      },
       {
        link: "https://www.reinventingorganizations.com/",
        subTitle: "Reinventing Organizations",
        subText: "An excellent book for anyone that wants to really dig into what is possible in business: trusting employees, letting those closest to the work make decisions, and rejecting traditional org models. The result = meaningful work and effective teams.",
      },
       {
        link: "https://bookshop.org/books/superhuman-social-skills-a-guide-to-being-likeable-winning-friends-and-building-your-social-circle/9781515179870",
        subTitle: "Superhuman Social Skills",
        subText: "Tynan is an exceptional writer. His succinct, down to earth style never gets stuck in research or having to repeatedly prove his points. This book makes my Favorites list for its advice and the reminder that our ability to connect with people and build friendships is a skill like any other.",
      },
      {
        link: "https://bookshop.org/books/the-great-bridge/9780671457112",
        subTitle: "The Great Bridge",
        subText: "An exceptional book about New York, Brooklyn and the bridge that connects them. It’s a historical book, but is compelling, never slow and shows that great things are possible with resilience.",
      },
    ],
  },
    ...
    items: [
      {
        ...
        subText: "An excellent bag for overnight trips that are 2 to 10 days long. Noah Kagan got this for me in 2013 and I’ve used it for every domestic and international trip since. Has a hidden built in backpack as well.",
      },
      {
      ...
      },
      {
        ...
        subText: "The best shorts I’ve ever worn. Comfortable and cool they work great for summer lounging or year round runs.",
      },
      {
        link: "https://olukai.com/products/ohana-mens-beach-sandals-dark-java-ray",
        subTitle: "Olukai ‘Ohana Sandals",
        subText: "Comfortable, durable and as stylish as flip-flops can be. I’ve worn two pairs over the last 6 years.",
      },
      {
        link: "https://buy.garmin.com/en-US/US/p/602068",
        subTitle: "Garmin vivoactive 3 watchm",
        subText: "I hate the learning curve for Garmin’s eco-system, but got used it to after a couple of months. This has become a favorite item and being able to leave my phone at home while still having GPS and music on a run has been helpful.",
      },
      {
        link: "https://www.youtube.com/watch?v=0TjLYgN3tEg",
        subTitle: "Chrome Pike Backpack",
        subText: "A great EDC (every day carrier) that is versatile and has some cool access and pockets. (Link is a video because Chrome doesn't offer the grey color anymore.)",
      },
      {
